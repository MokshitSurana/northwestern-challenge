...
uv run scripts/02_entity_resolver.py --limit 5000 --dry-run    # quick smoke test

# Tune fuzzy thresholds
uv run scripts/02_entity_resolver.py --threshold 90              # looser org
uv run scripts/02_entity_resolver.py --person-threshold 97       # stricter person
```
