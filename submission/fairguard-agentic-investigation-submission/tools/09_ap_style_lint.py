...
Usage:
    uv run tools/09_ap_style_lint.py findings/findings_report.md
    uv run tools/09_ap_style_lint.py findings/*.md notes/05_finding_*.md
    uv run tools/09_ap_style_lint.py --quiet findings/findings_report.md
    uv run tools/09_ap_style_lint.py --hook findings/findings_report.md
