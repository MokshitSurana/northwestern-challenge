...
SCRIPT = REPO_ROOT / "skills" / "press-release-cross-ref" / "scripts" / "05_pressrel_search.py"
...
class TestIntegration:
    ...
    def test_real_case_file_runs(self):
        case_path = REPO_ROOT / "skills" / "press-release-cross-ref" / "cases" / "steinberg_clients.json"
