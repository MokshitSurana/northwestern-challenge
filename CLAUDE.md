...
committee releases), plus a USAspending.gov money trail: Limbaugh's water-district
clients drew $43.3M in Bureau of Reclamation awards; Steinberg's client Talon Nickel
received a $114.8M DOE award. Kept here (not in `notes/06`) precisely because `notes/06`
is regenerated by the scan. Money trails are framed as conflict-of-interest *structure*,
not wrongdoing.
...
1. **Deepen the journalism** — extend the USAspending money trail beyond the two strong
